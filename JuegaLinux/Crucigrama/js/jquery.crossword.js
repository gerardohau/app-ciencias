...
* 
* Modificado por Juan Manuel Rivas Quiroz (Realmente esto ya es 95% mio con todo lo que hice)
*/
		...
		console.log('funcStart');
				...
				calcCoords: function() {
					...
					*/
					...
					for (var i = 0, p = entryCount; i < p; ++i) {		
						...
						$('#' + puzz.data[i].orientation).append('<li class="nonumber" tabindex="1" data-position="' + i + '">' + puzz.data[i].clue + '</li>'); 
					}				
			...
			buildEntries: function() {
				...
				*/
				checkAnswer: function(e) {
					...
					valToCheck = puzz.data[activePosition].answer;
					...
					if(check[puzz.data[activePosition].position-1]==false){
						if(valToCheck === currVal){	
							...
							//saizu++;
							//Reemplaza las imagenes de los elementos ya respondidos
							...
							//console.log("entry"+puzz.data[activePosition].position);
							var disab = document.getElementsByClassName("done");
							for (var oneb = 0; oneb < disab.length; oneb++) { 
    							disab[oneb].disabled = true;
								}
							return;
						}
					}else{
			...
			var util = {
				...
				highlightClue: function() {
					...
					document.getElementById("img"+puzz.data[activePosition].position).className += " clues-active";
